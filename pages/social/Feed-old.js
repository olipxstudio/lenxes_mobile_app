    ...
    const fakeData = [
        {
            'name':'oke',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/product/iphone/standard/Apple-iPhone-14-Pro-iPhone-14-Pro-Max-SOiP-main-1x-bw-220907_big.jpg.large.jpg'
        },
        {
            'name':'pius',
            'type':'text'
        },
        {
            'name':'peace',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/product/iphone/standard/Apple-iPhone-14-Pro-iPhone-14-Pro-Max-SOiP-main-2x-portrait-mode-220907_big.jpg.large.jpg'
        },
        {
            'name':'kennth',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/environments/stores/Apple-Brompton-Road-London-opening-store-queue_big.jpg.large.jpg'
        },
        {
            'name':'peter',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/product/iphone/standard/Apple-iPhone-14-Pro-iPhone-14-Pro-Max-SOiP-main-1x-lowlight-220907_big.jpg.large.jpg'
        },
        {
            'name':'anna',
            'type':'text'
        ...
        },
        {
            'name':'james',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/product/app-store/Apple-App-Store-AAPI-developer-Dawoon-Kang_inline.jpg.large.jpg'
        },
        {
            'name':'john',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/environments/stores/Apple-Brompton-Road-London-opening-performance_big.jpg.large.jpg'
        },
        {
            'name':'ororo',
            'type':'text'
        ...
        },
        {
            'name':'kate',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/product/app-store/Apple-App-Store-AAPI-developer-hero_Full-Bleed-Image.jpg.large.jpg'
        },
        {
            'name':'chuks',
            'type':'img',
            'img':'https://www.apple.com/newsroom/images/environments/stores/Apple-Brompton-Road-London-opening-customers-iPad-mini-Apple-Pencil_big.jpg.large.jpg'
        },
    ]
            ...
            <SafeAreaView style={{flex:1}}>
                ...
                <View style={styles.header_cont}>
                    ...
                    <View style={styles.hd_head_options}>
                        <Ionicons onPress={()=>alert('good')} name="play-outline" size={24} color={Colors.black} style={styles.hdJiveBtn} />
                    </View>
                </View>
                ...
                <View style={styles.main}>
                    <FlatList
                        ...
                        ListHeaderComponent={
                            <>
                                <ScrollView showsHorizontalScrollIndicator={false} style={styles.feed_posts} horizontal>
                                    <View>
                                        <View>
                                            <View></View>
